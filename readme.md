...
Estudante de Ciência da Computação e Desenvolvedor focado em transformar dados em decisões e construir soluções escaláveis. Atualmente baseado em Ubá, Minas Gerais.

## 🚀 Sobre Mim
- 🎓 Estudante de **Ciência da Computação**.
- 🛠️ Especialista em criar pontes entre **Dados e Desenvolvimento Full-Stack**.
- 📊 Atualmente aprofundando conhecimentos em **Business Intelligence** e **Microsoft Fabric**.
- 🤖 Interessado em automação com **n8n** e integração de IA em processos empresariais.
